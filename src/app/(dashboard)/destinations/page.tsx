...
export default function DestinationsPage() {
  ...
  const handleDelete = async () => {
    ...
    if (error) {
      ...
      fetchDestinations(currentPage, false);
    }
    setDeletingId(null);
  };
            ...
            >
              <div className="relative aspect-video w-full bg-black/5 overflow-hidden">
                {destination.image_url ? (
                  <ImageWithFallback
                    ...
                    fallback={
                      <div className="flex items-center justify-center h-full w-full text-muted-foreground bg-[#000000]/5">
                ...
                <div className="absolute bottom-2 left-2">
                  ...
                  >
                    {destination.is_active ? "Published" : "Draft"}
                  </Badge>
                </div>
                <div className="absolute top-2 right-2">
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent
                      align="end"
                      className="bg-[#F8EFD8] rounded-sm p-2 mt-2 space-y-1 w-28"
                    >
                      <DropdownMenuItem
                        onClick={() => handleEdit(destination)}
                        className="cursor-pointer flex gap-2 items-center px-2 py-1 rounded-sm hover:bg-black/5"
                      >
                      ...
                      <DropdownMenuItem
                        ...
                        className="cursor-pointer flex gap-2 items-center px-2 py-1 rounded-sm text-red-500 hover:bg-red-500/10"
                      >
              ...
              <div className="p-4 grid gap-4">
                ...
                <CardContent className="flex-1 p-0">
                  <p className="line-clamp-4 text-sm text-[#2D2D2D]/80">
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              destination and remove it from our servers.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
